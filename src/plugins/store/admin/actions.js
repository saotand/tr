...
export default {
    ...
    admin_a_edit_users: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        commit('ui_m_loading', true);
        let ID = payload.ID;
    ...
    admin_a_del_users: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        commit('ui_m_loading', true);
        let ID = payload;
    ...
    admin_a_add_brands: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
    ...
    admin_a_edit_brands: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload.ID;
    ...
    admin_a_del_brands: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload;
    ...
    admin_a_add_model: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
    ...
    admin_a_edit_model: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload.ID;
    ...
    admin_a_del_model: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload;
    ...
    admin_a_add_parts: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
    ...
    admin_a_edit_parts: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload.ID;
    ...
    admin_a_del_parts: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload;
    ...
    admin_a_add_subparts: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
    ...
    admin_a_edit_subparts: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload.ID;
    ...
    admin_a_del_subparts: ({ commit }, payload) => {
        const Token = sessionStorage.getItem("token");
        const options = { headers: { 'Authorization': Token } };
        let ID = payload;
