<template>
  <span>
    <v-toolbar :clipped-left="$vuetify.breakpoint.lgAndUp" app fixed>
      <v-toolbar-title>
        <v-btn flat style="margin:0;padding:0;height:64px;">
          <span style="position:relative; top:-3px;">
            <img class="logomain img-responsive" v-if="darkset" src="@/assets/logominidark.png" />
            <img class="logomain img-responsive" v-else src="@/assets/logomini.png" />
          </span>
        </v-btn>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat v-if="user" @click="userSignOut">
