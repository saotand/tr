  ...
  <span>
    ...
    >
      <span v-if="preview && previewfirst">
        <v-avatar style="margin:15px" v-if="preview && previewfirst" :size="size">
          <img v-if="image" :src="image" class="img-responsive" />
          <img v-else-if="src" :src="src" class="img-responsive" />
          <img v-else src="@/assets/no-photo-available.png" class="img-responsive" />
        </v-avatar>
      </span>
      <v-btn :small="small" :large="large" :block="block" @click="seleccionar" :color="color">
      ...
      <span v-if="preview && !previewfirst">
        <v-tooltip top>
          <v-avatar v-if="preview && !previewfirst" :size="size">
            <img v-if="image" :src="image" class="img-responsive" />
            <img v-else-if="src" :src="src" class="img-responsive" />
            <img v-else src="@/assets/no-photo-available.png" class="img-responsive" />
          </v-avatar>
    ...
    <v-btn v-else icon @click="seleccionar">
