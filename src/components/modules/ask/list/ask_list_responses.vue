      ...
      <template v-slot:items="props">
        ...
        <td>
          <app-tooltip
            top
            tooltip="Responder"
            v-if="!props.item.asked"
          >
            <v-btn
              icon
              color="green"
              @click="resp(props.item)"
            >
            ...
            <v-layout>
              <v-flex xs12>
                <v-textarea
                  ...
                  multi-line
                  label="Descripcion"
                  hint="Por favor no colocar informacion de contacto o enlaces externos a este sitio, las respuestas ser�n verificadas"
                  persistent-hint
                ></v-textarea>
              </v-flex>
            </v-layout>
